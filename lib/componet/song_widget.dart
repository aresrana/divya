...
class SongWidget extends StatefulWidget {
  ...
  final CollectionReference _playlist =
  FirebaseFirestore.instance.collection('Playlist');

  SongWidget({required this.song, required this.playingSongList, Key? key})
      : super(key: key);
                        ...
                        SizedBox(
                            ...
                            child: Row(children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  Navigator.push(context,MaterialPageRoute(builder: (context) => Lyrics(widget.song.url,widget.song.title)));
                                },
                              ),
                              const SizedBox(
                                width: 2,
